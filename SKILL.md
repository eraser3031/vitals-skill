...
Before starting the conversation, check if a Vitals diagnosis context file exists. This file is generated by the Vitals app and contains information about all connected repos in the project.
...
4. If the context file exists, use it to understand the full project scope — all connected repos, recent commits, and file structures. Reference this information throughout the diagnosis.
5. If no context file is found, proceed normally with just the current repo.

This step is silent — do not mention the context loading process to the user. Simply use the gathered information to ask better, more informed questions.
